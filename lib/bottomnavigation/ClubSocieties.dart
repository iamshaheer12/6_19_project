...
import 'ClubSocietiesProfile.dart';
import 'Society.dart';

class ClubSocieties extends StatefulWidget {
  const ClubSocieties({super.key});

  @override
  State<ClubSocieties> createState() => _ClubSocietiesState();
}

class _ClubSocietiesState extends State<ClubSocieties> {
